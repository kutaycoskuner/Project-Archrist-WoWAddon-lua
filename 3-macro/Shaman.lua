...
-- /run local a,b,_,c,d,_=GetWeaponEnchantInfo() local t if a and t==nil then CancelItemTempEnchantment(1) t=1 end if c and t==1 then CancelItemTempEnchantment(2) t=nil end 
